            ...
            <ul className={'hidden text-sm lg:block'}>
              ...
              <li>
                <a href={`#TECHNICAL TOOLKIT`}>
                  <div
                    className={`group flex gap-3 mb-8 w-min ${activeId === 'TECHNICAL TOOLKIT' ? 'active' : ''}`}>
                    <div
              ...
              <li>
                <a href={`#ABOUT`}>
                  <div
                    className={`group flex gap-3 mb-8 w-min ${activeId === 'ABOUT' ? 'active' : ''}`}>
                    <div
                      className={'bg-white w-8 h-0.5 rounded-full self-center group-hover:w-16 group-hover:bg-indigo-200 transition-all group-[.active]:w-16 group-[.active]:bg-indigo-200'}/>
                    <h2
              ...
              <li>
                <a href={`#EDUCATION`}>
                  <div
                    className={`group flex gap-3 mb-8 w-min ${activeId === 'EDUCATION' ? 'active' : ''}`}>
                    <div
                      className={'bg-white w-8 h-0.5 rounded-full self-center group-hover:w-16 group-hover:bg-indigo-200 transition-all group-[.active]:w-16 group-[.active]:bg-indigo-200'}/>
                    <h2
        ...
        <div className={'max-w-2xl lg:w-full'}>
          ...
          <section id={'ABOUT'} className={'pt-32'}>
            ...
            <p className={'mb-6'}>
              ...
              passionate about the art of turning ideas into tangible digital solutions. My journey in web development
              began with simple curiosity and has flourished into a career dedicated to exploring new technologies, such
              as <span className={'text-white font-bold'}>React</span>, <span
              className={'text-white font-bold'}>Next.js</span>, and <span
              className={'text-white font-bold'}>Typescript</span>.
              Through my experiences at <span className={'text-white font-bold'}>Transfert Pro</span> and <span
              className={'text-white font-bold'}>Wallix</span>, I have developed and maintained robust architectures
              in <span className={'text-white font-bold'}>C#</span> and <span
              className={'text-white font-bold'}>Symfony</span>, while creating secure and high-performance web
              applications. My personal projects, such as building a social network with <span
              className={'text-white font-bold'}>Next.js</span> and <span
              className={'text-white font-bold'}>Prisma</span>, demonstrate my ability to design and implement
              innovative features.
            </p>
            <p className={'mb-6'}>
              Outside the digital world, I find my inspiration in the tranquility of nature, the depth of music, and the
              enriching company of my friends. These passions, far from diverting me from my profession, enhance
              my <span className={'text-white font-bold'}>creativity</span> and <span
              className={'text-white font-bold'}>optimism</span>.
            </p>
            <p className={''}>
              Currently pursuing a Master&apos;s in Web Development in Lyon, I am constantly on the lookout for new
              challenges and open to discussions on technological innovations. If you are<span
              className={'text-white font-bold'}> in search of a motivated developer</span> to bring a new dimension to
              your projects or to exchange ideas on the future of the web, I would be delighted to meet you. Together,
              let&apos;s explore the possibilities that web development offers to turn your visions into reality.
            </p>
          ...
          <section id={'EDUCATION'} className={'pt-32'}>
            ...
            <div className={'flex flex-col gap-10'}>
              ...
              <article className={'flex gap-5 lg:gap-14'}>
                ...
                <div>
                  <a
                    href={'https://formations.univ-grenoble-alpes.fr/fr/catalogue-2021/but-bachelor-universitaire-de-technologie-CBB/but-metiers-du-multimedia-et-de-l-internet-KI4YX5MN/parcours-developpement-web-et-dispositifs-interactifs-KWDMXUGX.html'}>
          ...
          <section id={'EXPERIENCE'} className={'pt-32'}>
            ...
            <div className={'flex flex-col gap-14 lg:gap-20'}>
              <article>
                ...
                <p className={'pb-5'}>
                  A remake of my social media project, this time using Next.js and Prisma, to enhance my skills in
                  these technologies.
                </p>
                <div className={'flex gap-5'}>
                  <div className={'rounded-full px-5 py-2 bg-blue-950 w-fit'}><p>Next</p></div>
                  <div className={'rounded-full px-5 py-2 bg-blue-950 w-fit'}><p>Next Auth</p></div>
                  <div className={'rounded-full px-5 py-2 bg-blue-950 w-fit'}><p>Next UI</p></div>
                  <div className={'rounded-full px-5 py-2 bg-blue-950 w-fit'}><p>Prisma</p></div>
                </div>
              </article>
              <article>
                <div className={'flex flex-col lg:flex-row gap-4'}>
                ...
                <div className={'flex gap-5'}>
                  ...
                  <div className={'rounded-full px-5 py-2 bg-blue-950 w-fit'}><p>Cypress</p></div>
                </div>
              </article>
              <article>
                <div className={'flex flex-col lg:flex-row gap-4'}>
