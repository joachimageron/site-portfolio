      ...
      <div className="z-10 justify-center bg-darkbg px-6 py-12 text-main-text flex flex-col items-center lg:flex-row lg:items-start lg:px-24 lg:py-0 lg:gap-10">
        <header className="max-w-2xl w-full relative lg:sticky lg:top-0 lg:h-screen lg:py-16 lg:flex lg:flex-col lg:justify-between	">
          <div>
            ...
            <p>Crafting seamless, robust, and cutting-edge solutions</p>
            <p>for the modern web, one line of code at a time.</p>
            <p className={"mt-5"}>
              <a
                className={"underline"}
        ...
        <div className={"max-w-2xl lg:w-full"}>
          ...
          <section id={"ABOUT"} className={"pt-32"}>
            ...
            <p className={"mb-6"}>
              Hello, I&apos;m{" "}
              <span className={"text-white font-bold"}>Joachim Ageron</span>, a
              Full Stack developer passionate about the art of turning ideas
              into tangible digital solutions. My journey in web development
              began with simple curiosity and has flourished into a career
              dedicated to exploring new technologies, such as{" "}
              ...
              <span className={"text-white font-bold"}>Transfert Pro</span> and{" "}
              <span className={"text-white font-bold"}>Wallix</span>, I have
              developed and maintained robust architectures in{" "}
              <span className={"text-white font-bold"}>C#</span>, while creating
              secure and high-performance web applications. My personal
              projects, such as building a social network with{" "}
              <span className={"text-white font-bold"}>Next.js</span> and{" "}
              <span className={"text-white font-bold"}>Prisma</span>,
              demonstrate my ability to design and implement innovative
              features.
            </p>
            <p className={"mb-6"}>
              Outside the digital world, I find my inspiration in the
              tranquility of nature, the depth of music, and the enriching
              company of my friends. These passions, far from diverting me from
              my profession, enhance my{" "}
              <span className={"text-white font-bold"}>creativity</span> and{" "}
              <span className={"text-white font-bold"}>optimism</span>.
            </p>
            <p className={""}>
              Currently pursuing a Master&apos;s in Web Development in Lyon, I
              am constantly on the lookout for new challenges and open to
              discussions on technological innovations. If you are
              <span className={"text-white font-bold"}>
                {" "}
                in search of a motivated developer
              </span>{" "}
              to bring a new dimension to your projects or to exchange ideas on
              the future of the web, I would be delighted to meet you. Together,
              let&apos;s explore the possibilities that web development offers
          ...
          <section id={"EXPERIENCE"} className={"pt-32"}>
            ...
            <div className={"flex flex-col gap-14 lg:gap-20"}>
              <article>
                ...
                <p className={"pb-5"}>
                  A remake of my social media project, this time using Next.js
                  and Prisma, to enhance my skills in these technologies.
                </p>
              ...
              <article>
                ...
                <p className={"pb-5"}>
                  At TransfertPro, I enhanced their secure data transfer
                  platform and developed my Full Stack development skills,
                  particularly in C#.
                </p>
                <div className={"flex gap-5"}>
                  <div className={"rounded-full px-5 py-2 bg-blue-950 w-fit"}>
              ...
              <article>
                <div className={"flex flex-col lg:flex-row gap-4"}>
                  <h3 className={"text-white font-bold pb-2 text-nowrap"}>
                    Cypress project from scratch at{" "}
                    <a
                      className={"underline"}
                      href={"https://www.transfertpro.com/"}
                    >
                  ...
                  <p className={"text-nowrap mb-4"}>2024 - 3 months</p>
                </div>
                <p className={"pb-5"}>
                  At TransfertPro, I built a comprehensive Cypress project from
                  the ground up. Additionally, I created PowerShell scripts to
                  periodically test all infrastructures and implemented a mail
                  system.
                </p>
                <div className={"flex gap-5"}>
                  <div className={"rounded-full px-5 py-2 bg-blue-950 w-fit"}>
              ...
              <article>
                <div className={"flex flex-col lg:flex-row gap-4"}>
                  ...
                  <p className={"text-nowrap mb-4"}>2023 - 2 months</p>
                </div>
                <p className={"pb-5"}>
                  During my internship at Wallix, I developed my front-end
                  development skills by working with React and creating SCSS
                  themes, enriching the backend interface of their security
                  solutions.
                </p>
                <div className={"flex gap-5"}>
                  <div className={"rounded-full px-5 py-2 bg-blue-950 w-fit"}>
              ...
              <article>
                <div className={"flex flex-col lg:flex-row gap-4"}>
                  <h3 className={"text-white font-bold pb-2 text-nowrap"}>
                    Messages application course project
                  </h3>
                  <p className={"text-nowrap mb-4"}>2024 - 3 weeks</p>
                </div>
                <p className={"pb-5"}>
                  In a course project, I created an instant messaging
                  application using Next.js, leveraging server-side rendering
                  for real-time communication and an enhanced user experience.{" "}
                </p>
              ...
              <article>
                <div className={"flex flex-col lg:flex-row gap-4"}>
                  <h3 className={"text-white font-bold pb-2 text-nowrap"}>
                    Escape game course project
                  </h3>
                  <p className={"text-nowrap mb-4"}>2024 - 2 months</p>
                </div>
                <p className={"pb-5"}>
                  For a course project, we developed an escape game application
                  using React Native, It will be played in june.
                </p>
                <div className={"flex gap-5 flex-wrap"}>
                  <div className={"rounded-full px-5 py-2 bg-blue-950 w-fit"}>
                    <p>TypeScript</p>
              ...
              <article>
                ...
                <p className={"pb-5"}>
                  For a course project, we built a social media platform using
                  native PHP.
                </p>
                <div className={"flex gap-5 flex-wrap"}>
                  <div className={"rounded-full px-5 py-2 bg-blue-950 w-fit"}>
